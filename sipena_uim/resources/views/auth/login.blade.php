...
<body class="flex justify-center items-center bg-[#1E3A5F] p-4 min-h-screen">
    ...
    <div class="bg-white shadow-2xl rounded-2xl w-full max-w-4xl overflow-hidden">
        <div class="flex lg:flex-row flex-col">
            ...
            {{-- LEFT PANEL --}}
            <div class="flex flex-col justify-between gap-8 bg-[#1E3A5F] p-8 lg:p-10 lg:w-1/2">
                <div>
                    <div class="flex justify-center items-center bg-white/10 mb-6 rounded-xl w-12 h-12">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        <div class="flex flex-shrink-0 justify-center items-center bg-white/10 rounded-lg w-8 h-8">
            ...
            {{-- RIGHT PANEL --}}
            <div class="flex flex-col justify-center p-8 lg:p-10 lg:w-1/2">
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}"
                                class="py-2.5 pr-4 pl-10 border border-gray-300 focus:border-transparent rounded-xl focus:outline-none focus:ring-[#1E3A5F] focus:ring-2 w-full text-sm"
    ...
    <div class="relative">
        ...
        <input id="password-input" type="password" name="password"
            class="py-2.5 pr-10 pl-10 border border-gray-300 focus:border-transparent rounded-xl focus:outline-none focus:ring-[#1E3A5F] focus:ring-2 w-full text-sm"
            placeholder="••••••••">
        {{-- Toggle button --}}
        <button type="button" onclick="togglePassword()"
            class="right-0 absolute inset-y-0 flex items-center pr-3.5 text-gray-400 hover:text-gray-600 transition-colors">
            {{-- Eye icon (show) --}}
            ...
            {{-- Eye-off icon (hide) --}}
            <svg id="icon-hide" class="hidden w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/>
                    ...
                    <button type="submit"
                        class="bg-[#1E3A5F] hover:bg-[#16304f] py-2.5 rounded-xl w-full font-semibold text-white text-sm transition-colors">
                        Login
                    </button>
                </form>
            </div>
