...
@section('content')
{{-- Stats --}}
<div class="gap-4 grid grid-cols-4 mb-6">
    <div class="bg-white p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="font-bold text-[#1E3A5F] text-3xl">{{ $stats['total_pegawai'] }}</h3>
    ...
    <div class="bg-white p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="font-bold text-yellow-600 text-3xl">{{ $stats['cuti_menunggu'] }}</h3>
    ...
    <div class="bg-white p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="font-bold text-orange-600 text-3xl">{{ $stats['jafa_menunggu'] }}</h3>
    ...
    <div class="bg-white p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="font-bold text-purple-600 text-3xl">{{ $stats['serdos_menunggu'] }}</h3>
        <p class="mt-1 text-gray-400 text-xs">Perlu diverifikasi</p>
    </div>
</div>
...
<div class="gap-5 grid grid-cols-3">
    <div class="col-span-2 bg-white p-6 border border-gray-200 rounded-xl">
        <div class="flex justify-between items-center mb-5">
            <div>
                <h3 class="font-semibold text-gray-800 text-sm">Tren Pengajuan Cuti</h3>
                <p class="mt-0.5 text-gray-400 text-xs">{{ now()->year }}</p>
            </div>
        </div>
        <canvas id="chartCuti" height="90"></canvas>
    </div>
    ...
    <div class="bg-white p-6 border border-gray-200 rounded-xl">
        ...
        <div class="space-y-2.5">
            <a href="{{ route('pegawai.create') }}"
                ...
                <div class="flex justify-center items-center bg-[#1E3A5F]/10 group-hover:bg-[#1E3A5F]/20 rounded-lg w-8 h-8">
                    <svg class="w-4 h-4 text-[#1E3A5F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                    </svg>
                </div>
                <span class="font-medium text-gray-700 group-hover:text-[#1E3A5F] text-sm">Tambah Pegawai</span>
            </a>
            <a href="{{ route('verifikasi.index') }}"
                ...
                <div class="flex justify-center items-center bg-orange-100 rounded-lg w-8 h-8">
                    <svg class="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                </div>
                <span class="font-medium text-gray-700 group-hover:text-orange-700 text-sm">Verifikasi Jafa/Serdos</span>
            </a>
            <a href="{{ route('laporan.pegawai') }}"
                ...
                <div class="flex justify-center items-center bg-green-100 rounded-lg w-8 h-8">
                    <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                </div>
                <span class="font-medium text-gray-700 group-hover:text-green-700 text-sm">Laporan Kepegawaian</span>
            </a>
            <a href="{{ route('laporan.cuti') }}"
                ...
                <div class="flex justify-center items-center bg-purple-100 rounded-lg w-8 h-8">
                    <svg class="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                </div>
                <span class="font-medium text-gray-700 group-hover:text-purple-700 text-sm">Laporan Cuti & Lembur</span>
            </a>
        </div>
    </div>
</div>
