...
<div class="bg-[#1E3A5F] mb-6 p-5 lg:p-6 rounded-2xl text-white">
    <div class="flex justify-between items-center">
        <div>
            ...
            <h2 class="mt-0.5 font-bold text-xl lg:text-2xl">{{ $pegawai->nama_lengkap }}</h2>
...
<div class="gap-4 grid grid-cols-1 sm:grid-cols-3 mb-6">
    <div class="bg-white p-4 lg:p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="text-2xl lg:text-3xl font-bold {{ $sisaCuti < 0 ? 'text-red-500' : 'text-[#1E3A5F]' }}">
            {{ $sisaCuti }}
        </h3>
    ...
    <div class="bg-white p-4 lg:p-5 border border-gray-200 rounded-xl">
        ...
        <h3 class="font-bold text-green-600 text-2xl lg:text-3xl">{{ $totalPengajuan }}</h3>
    ...
    <div class="bg-white p-4 lg:p-5 border border-gray-200 rounded-xl">
        ...
        <p class="mt-1 text-gray-400 text-xs">pengajuan terakhir</p>
    </div>
</div>
    ...
    <div class="bg-white p-5 border border-gray-200 rounded-xl">
        ...
        <div class="space-y-2">
            <a href="{{ route('cuti.create') }}"
                ...
                <svg class="ml-auto w-4 h-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('jafa.create') }}"
                ...
                <span class="font-medium text-gray-700 text-sm">Ajukan Surat Jafa</span>
                <svg class="ml-auto w-4 h-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            </a>
            <a href="{{ route('serdos.create') }}"
                ...
                <span class="font-medium text-gray-700 text-sm">Ajukan Surat Serdos</span>
                <svg class="ml-auto w-4 h-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
            </a>
